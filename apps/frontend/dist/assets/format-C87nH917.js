import {
  ...
  f as N,
  e as G,
} from "./en-US-D2VrG88w.js";
function k(e, t) {
  var f, c, g, h;
  const n = D(),
    r =
      (t == null ? void 0 : t.weekStartsOn) ??
      ((c = (f = t == null ? void 0 : t.locale) == null ? void 0 : f.options) ==
      null
        ? void 0
        : c.weekStartsOn) ??
      n.weekStartsOn ??
      ((h = (g = n.locale) == null ? void 0 : g.options) == null
        ? void 0
        : h.weekStartsOn) ??
      0,
    a = m(e),
...
function B(e) {
  if (!L(e) && typeof e != "number") return !1;
  const t = m(e);
...
function H(e, t) {
  ...
  const n = m(e),
    ...
    s =
      ...
      ((b = (h = t == null ? void 0 : t.locale) == null ? void 0 : h.options) ==
      null
        ? void 0
        : b.firstWeekContainsDate) ??
      a.firstWeekContainsDate ??
      ((Y = (x = a.locale) == null ? void 0 : x.options) == null
        ? void 0
...
const l = {
  ...
  p = {
    ...
    k: function (e, t, n) {
      ...
      return (
        r === 0 && (r = 24),
        t === "ko" ? n.ordinalNumber(r, { unit: "hour" }) : o(r, t.length)
      );
    },
    m: function (e, t, n) {
      return t === "mo"
...
function ut(e, t, n) {
  ...
  const r = D(),
    ...
    s =
      ...
      ((b = (h = r.locale) == null ? void 0 : h.options) == null
        ? void 0
        : b.firstWeekContainsDate) ??
      1,
    d =
      r.weekStartsOn ??
      ((Y = (x = r.locale) == null ? void 0 : x.options) == null
        ? void 0
        : Y.weekStartsOn) ??
      0,
    f = m(e);
  ...
  let c = t
    ...
    .map((u) => {
      ...
      const i = u[0];
      if (i === "'") return { isToken: !1, value: it(u) };
      if (p[i]) return { isToken: !0, value: u };
      if (i.match(ot))
  ...
  const g = { firstWeekContainsDate: s, weekStartsOn: d, locale: a };
  return c
    .map((u) => {
