export const growthKeys = {
  all: ["growth"] as const,
  workshops: (filters?: object) => [...growthKeys.all, "workshops", filters] as const,
  workshop: (id: string) => [...growthKeys.all, "workshops", id] as const,
  prospects: (filters?: object) => [...growthKeys.all, "prospects", filters] as const,
  ...
  brandAudits: (filters?: object) => [...growthKeys.all, "brand-audits", filters] as const,
